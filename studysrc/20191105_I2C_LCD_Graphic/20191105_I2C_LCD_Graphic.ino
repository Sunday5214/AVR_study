...
void GraphicLCD_Data(int x, int y, unsigned short data){
  Graphic_LCD_INST(0x20);
  Graphic_LCD_INST(0x60);
  Graphic_LCD_INST(0x80+(y%32) & 0xf0);
  Graphic_LCD_INST((0x80+(y%32) & 0x0f) << 4);
  Graphic_LCD_INST((0x80+(y/32)*8+x) & 0xf0);
  Graphic_LCD_INST((0x80+(y/32)*8+x) & 0x0f << 4);

  Graphic_LCD_INST(0x20);
  Graphic_LCD_INST(0x00);
  
  Graphic_LCD_DATA(((data & 0xff00)>>8) & 0xf0);
  Graphic_LCD_DATA((((data & 0xff00)>>8) & 0x0f) << 4);
  Graphic_LCD_DATA(((data & 0xff00)>>8) & 0xf0);
  Graphic_LCD_DATA((((data & 0xff00)>>8) & 0x0f) << 4);
//  Graphic_LCD_DATA((data & 0xff) & 0xf0);
//  Graphic_LCD_DATA(((data & 0xff) & 0x0f) << 4);
}
void LCDClear(){
  for(int j = 0; j<8; j++){
    for(int i = 0; i<64; i++){
      ...
      Graphic_LCD_INST(0x80+(i%32) & 0xf0);
      Graphic_LCD_INST((0x80+(i%32) & 0x0f) << 4);
      Graphic_LCD_INST((0x80+(i/32)*8+j) & 0xf0);
      Graphic_LCD_INST(((0x80+(i/32)*8+j) & 0x0f)<<4);

      Graphic_LCD_INST(0x20);
      Graphic_LCD_INST(0x00);
      
      Graphic_LCD_DATA(0x00);
      Graphic_LCD_DATA(0x00);
